...
export default function LayoutMenu() {
    ...
    const serverMenuData = useUserConfig(
        (state: any) => state.userConfig.menuItems
    );
    const menuData: IRoute[] = config.isRenderServerMenu
        ? serverMenuData
    ...
    const onOpenChange = (keys: string[]) => {
        ...
        const latestOpenKey =
            keys.length > 0 ? keys[keys.length - 1] : undefined;
